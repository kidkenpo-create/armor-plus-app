...
- DoD technical data / FAR 52.227-14: for the identified DoD issue-family pathway, check FAR/RFO FAR 27.400 and DFARS/RFO DFARS 227.400 before FAR 27.409. DFARS/RFO DFARS 227.400 redirects DoD to subparts 227.71 and 227.72 instead of FAR subpart 27.4. Likely determination for "technical data acquired, no 27.409(b)(1) exceptions, include FAR 52.227-14?" = NO for DoD; cite FAR/RFO FAR 27.400 and DFARS/RFO DFARS 227.400.
- Acquisition plan responsibility: for the identified DoD issue-family pathway, do not default to the contracting officer. RFO FAR Part 7 defines planner generally, but DFARS RFO PGI 207.104-70(b) states it is incumbent upon the program manager to coordinate the plan. Likely determination for "who is responsible for the acquisition plan?" = Program manager; cite DFARS RFO PGI 207.104-70(b).
